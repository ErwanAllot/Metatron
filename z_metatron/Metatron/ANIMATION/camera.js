...
function net(){spirale.style.animation = "mymove_NET_SEC 1s";}
function sec(){spirale.style.animation = "mymove_SEC_SOT 1s";}
function sot(){spirale.style.animation = "mymove_SOT_NOC 1s";}
function noc(){spirale.style.animation = "mymove_NOC_NET 1s";}
